...
if __name__ == "__main__":
    ...
    # # 待处理文件名，分成月份命名的
    filenames = [
        # "20240101_20240201 16053 条.csv"
        # "241201-wb公园关键词爬取-汇总.xlsx"
        # "20241201_20250101 51499 条.csv",
        # "20241101_20241201 54042 条.csv"
        # "20241001_20241101 53884 条.csv"
        "20240801_20240901 60312 条.csv"
    ]
    # # 百度NLP的Key值所在csv
    ...
    # # 给邮箱发邮件的相关参数设置
    emailname = "473161189@qq.com" # 邮箱地址
    emailpassword = "bhuyruumkxtabhgg"  # 授权码 需要到邮箱的设置里面 开启授权
    #####################################################################
    ...
    for filename in filenames:
        ...
        yag.send(
            to=emailname,
            subject="开始",
            contents="开始调用百度API分析文本信息\n" + "运行开始时间:"+str(datetime.datetime.now())+ f"{filename}",
        )
        ...
        def process_row(row):
            try:
                ...
                sleep(0.45)  # 大量测试 0.1算比较合适 可以适当减少
